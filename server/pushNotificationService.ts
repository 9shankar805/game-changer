...
export class PushNotificationService {
  ...
  private static async sendTestNotification(userId: number): Promise<boolean> {
    const payload: DeliveryNotificationPayload = {
      type: 'order_update',
      title: '🔔 Notifications Enabled - Siraha Bazaar',
      body: 'Great! Push notifications are now active. You\'ll receive real-time updates about your orders, deliveries, and special offers. Thank you for choosing Siraha Bazaar!',
      data: {},
      icon: '/icon-192x192.png',
      badge: '/icon-96x96.png'
    };
